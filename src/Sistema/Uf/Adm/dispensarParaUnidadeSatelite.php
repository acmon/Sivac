...
$unidade->ExibirOpcaoOperacaoDeEstoque(2);
...
$unidade->ExibirFormularioEstoqueDeVacinas();
		...
		if ($unidade->VerificarEstoque($quantidade, $vacina_id, $unidadeDeSaudeOrigem_id)) {
			...
			if ($idIncluido && $unidade->SalvarEstoque($unidadeDeSaudeDestino_id, $vacina_id, $quantidade, $codigoDeBarras, $produto)
				...
				// exibe msg de confirmação
                    ...
                    $unidade->ExibirMensagem("Serão dispensadas $quantidade dose(s) da vacina $nomeVacina
