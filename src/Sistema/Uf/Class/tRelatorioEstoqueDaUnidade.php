...
class RelatorioEstoqueDaUnidade extends Relatorio
{
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
    ...
    public function ExibirRelatorio()
    {
        ...
        $this->ImprimirCabecalho(Array('unidade_id'=>$unidade_id,'titulo'=>'Estoque de vacinas das unidades deste município'));
        $this->ExibirEstoqueDaUnidade($unidade_id);
    }
 //-----------------------------------------------------------------------------
