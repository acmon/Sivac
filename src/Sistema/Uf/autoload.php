...
require 'Class/tConstantes.php';

function __autoload($classe)
{
	
	if(file_exists("{$_SERVER['DOCUMENT_ROOT']}/" . Constantes::PASTA_SISTEMA . "/Uf/Class/t{$classe}.php") ) {
		
		require_once "{$_SERVER['DOCUMENT_ROOT']}/" . Constantes::PASTA_SISTEMA . "/Uf/Class/t{$classe}.php";
	}
}