...
if( isset($campanhaid, $vacinaid) ) {
	...
	$querystring = $crip->Cifrar("pagina=Adm/inserirVacinasNaCampanha&campanha=$campanhaid");
	
	$uri = $vacina->Url() . "/Uf?$querystring"; 
	
	$vacina->AtualizarJanelas($uri);
	
	$vacina->ExibirListaDeCaracteristicas($vacinaid, $campanhaid, 'inserirVacinasNaCampanha');
